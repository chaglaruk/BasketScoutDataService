"""Provider that serves public-display-safe daily web observations."""
...
class WebObservationProvider(BaseProvider):
    @property
    def name(self) -> str:
    ...
    def limitations(self) -> list[str]:
        return [
            "Daily observed public web pages only; not guaranteed live price.",
            "Only rows with public_display_allowed=true are exposed to compare.",
        ...
        try:
            ...
            if last_run is None:
                return ProviderStatusItem(
                    ...
                    status="limited",
                    type=self.type,
                    message="No daily observation run yet.",
